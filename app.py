...
def ProcessPrice():
    if request.method == "POST":
        ...
        # for i in session["user_components"]:
        # session["info"]=json.dumps({'component':session["user_components"][0][0],'price':session["user_components"][0][1],'comment':session["user_components"][0][2]});
